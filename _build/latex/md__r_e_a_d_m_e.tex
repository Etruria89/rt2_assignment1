...
\begin{DoxyItemize}
\item {\bfseries{go\+\_\+to\+\_\+point}}\+: ({\itshape go\+\_\+to\+\_\+point.\+py}) the action server managing the robot speed control depending on the goal received. This node publishes on the topics /cmd\+\_\+vel the velocity of the robot and read its position by subscribing the topic \textquotesingle{}/odom\textquotesingle{}
...
\item {\bfseries{state\+Machine}}\+: ({\itshape state\+\_\+machine.\+cpp}) the finite state machine managing the request of a new goal pose when needed, sending it as a goal to \textquotesingle{}go\+\_\+to\+\_\+point\textquotesingle{} action server.
